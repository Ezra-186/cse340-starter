...
-- Join speedup for inventory lookups
CREATE INDEX IF NOT EXISTS inventory_classification_idx
...
-- Task 4 copy: fix GM Hummer description 
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Task 6 copy: add "/vehicles" to paths 
UPDATE public.inventory
